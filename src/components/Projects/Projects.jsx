            ...
            <div className="links">
                ...
                <div className="card">
                    ...
                    <div class="card-reveal grey-text text-darken-4">
                        ...
                        <a href="https://pretty-palette-picker.herokuapp.com/" target="_blank"><span className="link-text">Check It Out!</span></a>
                    </div>
                </div>
                <div className="card">
                    <div class="card-image waves-effect waves-block waves-light">
                    ...
                    <div class="card-reveal">
                        ...
                        <a href="https://henrys-recipe-shopping-list.herokuapp.com/" target="_blank"> <span className="link-text">Check It Out!</span></a>
                    </div>
                </div>
                <div className="card">
                    <div class="card-image waves-effect waves-block waves-light">
